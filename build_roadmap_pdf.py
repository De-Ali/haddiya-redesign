...
arch = [
    ...
    ['Web (Frontend)', 'Next.js 14 (App Router) + TypeScript + Tailwind v4', 'SSR/ISR for SEO, mature i18n + RTL'],
    ...
    ['API Gateway / BFF', 'AWS API Gateway + REST; GraphQL BFF or tRPC optional', 'Tailored payloads per channel'],
